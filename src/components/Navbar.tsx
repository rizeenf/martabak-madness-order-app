                        ...
                        <NavigationMenuLink asChild>
                          ...
                          >
                            ...
                            <p className="text-sm leading-tight text-muted-foreground line-clamp-6">
                              ...
                              menikmati dunia martabak yang lezat. Temukan
                              beragam rasa manis dan gurih, dengan berbagai
                              pilihan topping yang menggugah selera. Pesan
                              dengan mudah melalui aplikasi pengiriman makanan
                              kami dan puaskan hasrat Anda akan makanan jalanan
                              Indonesia yang terkenal ini.
                            </p>
                          </Link>
                        </NavigationMenuLink>
                      </li>
                      <ListItem href="/" title="Tentang kami">
                        Kenal lebih dekat dengan MartabakMadnes, Informasi
                        mengenai kami, misi, nilai, dan sejarah kami.
                      </ListItem>
